...
const opt = {
  ...
  tierName:       DATA.Vestrans.T2.name,
  maxSupply:      DATA.Vestrans.T2.maxSupply,
  price:          numToParse(DATA.Vestrans.T2.price),
  point:          DATA.Vestrans.T2.point,
  maxAllocation:  DATA.Vestrans.T2.maxAllocation
}
console.log(opt);
async function main() {
