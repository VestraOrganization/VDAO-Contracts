...
const opt = {
  ...
  catId: DATA.Collaborations.categories[0].id,
  name: DATA.Collaborations.categories[0].name,
  pool: DATA.Collaborations.categories[0].pool,
  maxReward: DATA.Collaborations.categories[0].maxReward,
}
