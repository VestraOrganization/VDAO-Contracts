...
const opt = {
  ...
  catId:      DATA.Collaborations.categories[3].id,
  name:       DATA.Collaborations.categories[3].name,
  pool:       DATA.Collaborations.categories[3].pool,
  maxReward:  DATA.Collaborations.categories[3].maxReward,
}
