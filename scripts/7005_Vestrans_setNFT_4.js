...
const opt = {
  ...
  tierName:       DATA.Vestrans.T4.name,
  maxSupply:      DATA.Vestrans.T4.maxSupply,
  price:          numToParse(DATA.Vestrans.T4.price),
  point:          DATA.Vestrans.T4.point,
  maxAllocation:  DATA.Vestrans.T4.maxAllocation
}
