...
const opt = {
  ...
  catId:      DATA.Collaborations.categories[2].id,
  name:       DATA.Collaborations.categories[2].name,
  pool:       DATA.Collaborations.categories[2].pool,
  maxReward:  DATA.Collaborations.categories[2].maxReward,
}
